...
// Hero search field (design.md §3): generous height, orange focus ring, result
// count + clear when typing.
export function SearchField({ value, onChange, placeholder, resultCount, loading, clearLabel }: SearchFieldProps) {
  ...
  return (
    ...
    >
      ...
      />
      {loading && <span className="h-3.5 w-3.5 flex-none animate-spin rounded-full border-2 border-ink-3 border-t-transparent" />}
