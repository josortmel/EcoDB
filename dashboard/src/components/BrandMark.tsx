// Eco Consulting brand mark (design.md §2.10): square outline + 3 bars, the
// MIDDLE bar surgical orange, the others currentColor. Rendered BARE (no glass
// chip). Set the container's color (text-ink-1) so currentColor adapts —
// espresso in light, cream in dark.
