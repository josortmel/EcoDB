...
// Floating frosted card — the Liquid Glass signature (design.md §2.5). The
...
// (opacity 0 at rest → fades in only while hovered), so a stale --mx/--my at
// rest is never visible. Honors prefers-reduced-motion (the specular just
