...
from permissions import can_write_memory, precompute_read_visibility, check_read_memory
...
# `router` above is mounted at /agents). GET/POST /api/v1/agents live here.
